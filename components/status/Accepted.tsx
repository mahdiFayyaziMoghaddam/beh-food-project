...
export default function Accepted({list}: any) {
  return (
    <>
      <div className="relative top-0 w-full h-[122px] rounded-[10px] border-[#00000040] border-[0.2px] bg-white">
        <Image className="absolute top-[11px] right-[17px]" width={100} height={100} src={'images/paper.svg'} alt="paper" />
        ...
        <p className="absolute top-[46px] right-[153px] font-semibold w-auto h-[30px] leading-[30px]" style={{direction: 'rtl'}}>ثبت سفارش</p>
        <div className="flex flex-nowrap flex-row-reverse justify-start overflow-hidden absolute top-[81px] left-[27px] w-[244px] h-[19px] gap-[13px]" >
          {
            list.map((item: {name: string, image: string, number: number}) => {
              return <>
                <div className="relative flex flex-nowrap w-auto  min-w-[70px] h-full" style={{direction: 'rtl'}}>
