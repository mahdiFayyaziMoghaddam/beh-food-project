...
export default function Ready({list}: any) {
  return (
    <>
      <div className="relative top-0 w-full h-[122px] rounded-[10px] border-[#00000040] border-[0.2px] bg-white">
        <Image className="absolute top-[11px] right-[17px]" width={100} height={100} src={'images/dish.svg'} alt="paper" />
        ...
        <p className="absolute top-[46px] right-[153px] font-semibold w-auto h-[30px] leading-[30px]" style={{direction: 'rtl'}}>غذا آماده است!</p>
